...
public:
   ...
   */
  [[noreturn]] inline static void raise(const char* origin, int rc);
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#ga05dc5bbcc7da81a7345bd8676e8e0e3b
 */
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#gabeb52e4c4be21b329e31c4add1b71926
 */
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#gaf8148bf1b85f58e264e57194bafb03ef
 */
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#gae37b9aedcb3767faba3de8c1cf6d3473
 */
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#ga909b2db047fa90fb0d37a78f86a6f99b
 */
 ...
 *
 * @see
 * http://symas.com/mdb/doc/group__errors.html#ga0a83370402a060c9175100d4bbfb9f25
 */
 ...
 * @see
 * http://symas.com/mdb/doc/group__errors.html#gab4c82e050391b60a18a5df08d22a7083
 */
...
inline void lmdb::error::raise(const char* const origin, const int rc) {
  switch (rc) {
  case MDB_KEYEXIST:
    throw key_exist_error{origin, rc};
  case MDB_NOTFOUND:
    throw not_found_error{origin, rc};
  case MDB_CORRUPTED:
...
inline static void env_copy_fd(MDB_env* env, mdb_filehandle_t fd);
#endif
inline static void env_stat(MDB_env* env, MDB_stat* stat);
inline static void env_info(MDB_env* env, MDB_envinfo* stat);
inline static void env_sync(MDB_env* env, bool force);
inline static void env_close(MDB_env* env) noexcept;
inline static void env_set_flags(MDB_env* env, unsigned int flags, bool onoff);
inline static void env_get_flags(MDB_env* env, unsigned int* flags);
inline static void env_get_path(MDB_env* env, const char** path);
inline static void env_get_fd(MDB_env* env, mdb_filehandle_t* fd);
inline static void env_set_mapsize(MDB_env* env, std::size_t size);
inline static void env_set_max_readers(MDB_env* env, unsigned int count);
inline static void env_get_max_readers(MDB_env* env, unsigned int* count);
inline static void env_set_max_dbs(MDB_env* env, MDB_dbi count);
inline static unsigned int env_get_max_keysize(MDB_env* env);
#if MDB_VERSION_FULL >= MDB_VERINT(0, 9, 11)
inline static void env_set_userctx(MDB_env* env, void* ctx);
inline static void* env_get_userctx(MDB_env* env);
#endif
 ...
 */
inline static void lmdb::env_create(MDB_env** env) {
 ...
 */
inline static void lmdb::env_open(MDB_env* const env, const char* const path,
                                  const unsigned int flags, const mode mode) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga3bf50d7793b36aaddf6b481a44e24244
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga5d51d6130325f7353db0955dbedbc378
 */
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga5040d0de1f14000fa01fc0b522ff1f86
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga470b0bcc64ac417de5de5930f20b1a28
 */
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#gaf881dca452050efbd434cd16e4bae255
 */
inline static void lmdb::env_stat(MDB_env* const env, MDB_stat* const stat) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga18769362c7e7d6cf91889a028a5c5947
 */
inline static void lmdb::env_info(MDB_env* const env, MDB_envinfo* const stat) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga85e61f05aa68b520cc6c3b981dba5037
 */
inline static void lmdb::env_sync(MDB_env* const env, const bool force = true) {
...
/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga4366c43ada8874588b6a62fbda2d1e95
 */
inline static void lmdb::env_close(MDB_env* const env) noexcept {
  ::mdb_env_close(env);
}
 ...
 */
inline static void lmdb::env_get_path(MDB_env* const env, const char** path) {
 ...
 */
inline static unsigned int lmdb::env_get_max_keysize(MDB_env* const env) {
 ...
 */
inline static void lmdb::env_set_userctx(MDB_env* const env, void* const ctx) {
 ...
 */
inline static void* lmdb::env_get_userctx(MDB_env* const env) {
...
#endif
inline static void txn_commit(MDB_txn* txn);
inline static void txn_abort(MDB_txn* txn) noexcept;
inline static void txn_reset(MDB_txn* txn) noexcept;
inline static void txn_renew(MDB_txn* txn);
} // namespace lmdb
 ...
 */
inline static void lmdb::txn_begin(MDB_env* const env, MDB_txn* const parent,
                                   const unsigned int flags, MDB_txn** txn) {
...
/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#gaeb17735b8aaa2938a78a45cab85c06a0
 */
inline static MDB_env* lmdb::txn_env(MDB_txn* const txn) noexcept {
 ...
 */
inline static std::size_t lmdb::txn_id(MDB_txn* const txn) noexcept {
 ...
 */
inline static void lmdb::txn_commit(MDB_txn* const txn) {
...
/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga73a5938ae4c3239ee11efa07eb22b882
 */
inline static void lmdb::txn_abort(MDB_txn* const txn) noexcept {
  ::mdb_txn_abort(txn);
}

/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga02b06706f8a66249769503c4e88c56cd
 */
inline static void lmdb::txn_reset(MDB_txn* const txn) noexcept {
  ::mdb_txn_reset(txn);
}
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga6c6f917959517ede1c504cf7c720ce6d
 */
inline static void lmdb::txn_renew(MDB_txn* const txn) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga95ba4cb721035478a8705e57b91ae4d4
 */
inline static void lmdb::dbi_flags(MDB_txn* const txn, const MDB_dbi dbi,
                                   unsigned int* const flags) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga68e47ffcf72eceec553c72b1784ee0fe
 */
inline static void lmdb::dbi_set_compare(MDB_txn* const txn, const MDB_dbi dbi,
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#gacef4ec3dab0bbd9bc978b73c19c879ae
 */
inline static void lmdb::dbi_set_dupsort(MDB_txn* const txn, const MDB_dbi dbi,
                                         MDB_cmp_func* const cmp = nullptr) {
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga697d82c7afe79f142207ad5adcdebfeb
 */
inline static void lmdb::dbi_set_relfunc(MDB_txn* const txn, const MDB_dbi dbi,
...
namespace lmdb {
inline static void cursor_open(MDB_txn* txn, MDB_dbi dbi, MDB_cursor** cursor);
inline static void cursor_close(MDB_cursor* cursor) noexcept;
 ...
 * @throws lmdb::error on failure
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga9ff5d7bd42557fd5ee235dc1d62613aa
 */
inline static void lmdb::cursor_open(MDB_txn* const txn, const MDB_dbi dbi,
...
/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#gad685f5d73c052715c7bd859cc4c05188
 */
inline static void lmdb::cursor_close(MDB_cursor* const cursor) noexcept {
...
/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga7bf0d458f7f36b5232fcb368ebda79e0
 */
inline static MDB_txn* lmdb::cursor_txn(MDB_cursor* const cursor) noexcept {
  return ::mdb_cursor_txn(cursor);
}

/**
 * @see
 * http://symas.com/mdb/doc/group__mdb.html#ga2f7092cf70ee816fb3d2c3267a732372
 */
inline static MDB_dbi lmdb::cursor_dbi(MDB_cursor* const cursor) noexcept {
...
public:
   ...
   * Constructor.
   */
  val(const std::string& data) noexcept : val{data.data(), data.size()} {
  }

  /**
   * Constructor.
   */
  val(const char* const data) noexcept : val{data, std::strlen(data)} {
  }
...
public:
   ...
   */
  env(MDB_env* const handle) noexcept : _handle{handle} {
  }
...
public:
   ...
   * @throws lmdb::error on failure
   */
  static txn begin(MDB_env* const env, MDB_txn* const parent = nullptr,
   ...
   */
  txn(MDB_txn* const handle) noexcept : _handle{handle} {
  }
...
public:
   ...
   * @throws lmdb::error on failure
   */
  static dbi open(MDB_txn* const txn, const char* const name = nullptr,
                  const unsigned int flags = default_flags) {
    MDB_dbi handle{};
   ...
   */
  dbi(const MDB_dbi handle) noexcept : _handle{handle} {
  }
   ...
   * @throws lmdb::error on failure
   */
  bool put(MDB_txn* const txn, const val& key, val& data,
   ...
   */
  template <typename K, typename V>
  bool put(MDB_txn* const txn, const K& key, const V& val,
           const unsigned int flags = default_put_flags) {
    const lmdb::val k{&key, sizeof(K)};
   ...
   */
  template <typename V>
  bool put(MDB_txn* const txn, const char* const key, const V& val,
           const unsigned int flags = default_put_flags) {
    const lmdb::val k{key, std::strlen(key)};
    lmdb::val v{&val, sizeof(V)};
    return lmdb::dbi_put(txn, handle(), k, v, flags);
   ...
   * @throws lmdb::error on failure
   */
  bool put(MDB_txn* const txn, const char* const key, const char* const val,
           const unsigned int flags = default_put_flags) {
    const lmdb::val k{key, std::strlen(key)};
...
public:
   ...
   */
  cursor(MDB_cursor* const handle) noexcept : _handle{handle} {
  }
