...
struct WorkerCounters {
  ...
  atomic<u64> dt_restarts_update_same_size[max_dt_id] = {0};

  // includes insert, remove, update with different size
  atomic<u64> dt_restarts_structural_change[max_dt_id] = {0};
  atomic<u64> dt_restarts_read[max_dt_id] = {0};

  // temporary counter used to track some value for an idea in my mind
  atomic<u64> dt_researchy[max_dt_id][max_researchy_counter] = {};
