...
void CRTable::open() {
  ...
  columns.emplace("wal_reserve_blocked", [&](Column& col) {
    col << (sum(CRCounters::cr_counters, &CRCounters::wal_reserve_blocked));
  });
  columns.emplace("wal_reserve_immediate", [&](Column& col) {
    col << (sum(CRCounters::cr_counters, &CRCounters::wal_reserve_immediate));
  });
  ...
  columns.emplace("gct_committed_tx", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::gct_committed_tx);
  });
  columns.emplace("gct_rounds", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::gct_rounds);
  });
  ...
  columns.emplace("rfa_committed_tx", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::rfa_committed_tx);
  });
  // -------------------------------------------------------------------------------------
  columns.emplace("cc_snapshot_restart", [](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_snapshot_restart);
  });
  // -------------------------------------------------------------------------------------
  ...
  columns.emplace("gct_write_gib", [&](Column& col) {
    col << (sum(CRCounters::cr_counters, &CRCounters::gct_write_bytes) * 1.0) /
               1024.0 / 1024.0 / 1024.0;
  });
  ...
  columns.emplace("cc_ms_olap_tx", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_olap_tx);
  });
  columns.emplace("cc_ms_gc", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_gc);
  });
  columns.emplace("cc_ms_gc_cm", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_gc_cm);
  });
  columns.emplace("cc_ms_gc_graveyard", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_gc_graveyard);
  });
  columns.emplace("cc_ms_gc_history_tree", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_gc_history_tree);
  });
  columns.emplace("cc_ms_fat_tuple", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_fat_tuple);
  });
  columns.emplace("cc_ms_fat_tuple_conversion", [&](Column& col) {
    col << sum(CRCounters::cr_counters,
               &CRCounters::cc_ms_fat_tuple_conversion);
  });
  columns.emplace("cc_ms_snapshotting", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_snapshotting);
  });
  columns.emplace("cc_ms_committing", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_committing);
  });
  columns.emplace("cc_ms_history_tree_insert", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_history_tree_insert);
  });
  columns.emplace("cc_ms_history_tree_retrieve", [&](Column& col) {
    col << sum(CRCounters::cr_counters,
               &CRCounters::cc_ms_history_tree_retrieve);
  });
  ...
  columns.emplace("cc_ms_commit_tx", [&](Column& col) {
    col << sum(CRCounters::cr_counters, &CRCounters::cc_ms_commit_tx);
  });
