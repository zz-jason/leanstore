...
TxnKvHandle* CreateTxnKv(LeanStoreHandle* handle, uint64_t workerId, const char* btreeName);
...
bool TxnKvInsert(TxnKvHandle* handle, uint64_t workerId, StringSlice key, StringSlice val);
