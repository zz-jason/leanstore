...
public:
  ...
  WalInitPage(TXID sysTxId, TREEID treeId, bool isLeaf)
...
public:
  ...
  WalSplitRoot(TXID sysTxId, PID newLeft, PID newRoot, PID metaNode,
...
public:
  ...
  WalSplitNonRoot(TXID sysTxId, PID parent, PID newLeft, const BTreeNode::SeparatorInfo& sepInfo)
