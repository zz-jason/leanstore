...
class BTreeMvccImpl {
public:
  static struct lean_btree* Create(leanstore::storage::btree::TransactionKV* btree,
...
private:
  BTreeMvccImpl(leanstore::storage::btree::TransactionKV* btree, SessionImpl* session_impl)
      : btree_(btree),
...
private:
  lean_btree base_;
  storage::btree::TransactionKV* btree_;
