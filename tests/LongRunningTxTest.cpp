...
TEST_F(LongRunningTxTest, LookupFromGraveyard) {
  ...
  mStore->ExecSync(1, [&]() { cr::WorkerContext::My().StartTx(); });
...
TEST_F(LongRunningTxTest, LookupAfterUpdate100Times) {
  ...
  mStore->ExecSync(1, [&]() {
    ...
    auto* updateTree = cr::WorkerContext::My().mCc.mHistoryStorage.GetUpdateIndex();
    auto* removeTree = cr::WorkerContext::My().mCc.mHistoryStorage.GetRemoveIndex();
